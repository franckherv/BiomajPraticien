...
class ConsultationUserInfoWidget extends StatefulWidget {
  ...
  ConsultationUserInfoWidget({Key? key, this.consultatingData}) : super(key: key);

  @override
  State<ConsultationUserInfoWidget> createState() => _ConsultationUserInfoWidgetState();
}

class _ConsultationUserInfoWidgetState extends State<ConsultationUserInfoWidget> {
              ...
              children: [
                 ...
                 ListTile(
                  ...
                  title: const Text("Date consultation"),
                   trailing: widget.consultatingData!.createdAt != null ?  Text(CommonVariable.ddMMYYFormat.format(DateTime.parse(widget.consultatingData!.createdAt.toString()))) : Text("Vide"),
